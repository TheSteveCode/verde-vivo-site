  ...
  return (
    <div className="container d-block p-2">
      ...
      <div>
        ...
        <ul>
            <li>🌻 <strong>Guías Paso a Paso:</strong> Aprende desde los conceptos básicos hasta técnicas avanzadas con nuestras detalladas guías ilustradas.</li>
            <li>🌷 <strong>Herramientas Innovadoras:</strong> Optimiza tu tiempo y esfuerzo con nuestras herramientas digitales, diseñadas para ayudarte a planificar, plantar y cuidar tu jardín con precisión.</li>
            <li>🌿 <strong>Comunidad Vibrante:</strong> Únete a nuestra comunidad de jardineros apasionados, comparte tus experiencias, recibe consejos y resuelve tus dudas en tiempo real.</li>
            <li>🍃 <strong>Actualizaciones Constantes:</strong> Mantente al día con las últimas tendencias y técnicas de jardinería sostenible.</li>
        ...
        <ul>
            ...
            <li><strong>Contenido Exclusivo:</strong> Acceso a artículos, videos y webinars creados por expertos.</li>
            <li><strong>Asesoramiento Personalizado:</strong> Recibe recomendaciones basadas en tus necesidades y las características de tu jardín.</li>
            <li><strong>Compatibilidad Multidispositivo:</strong> Accede a nuestra web app desde tu computadora, tablet o smartphone.</li>
        </ul>

        <h2><strong>¡Empieza Hoy!</strong> 🌻</h2>
